...
import com.whatsapp.whatsapppclone.activity.ChatActivity
import com.whatsapp.whatsapppclone.databinding.ChatUserItemLayoutBinding
...
class ChatAdapter(var context: Context, private var list: ArrayList<UserModel>) :RecyclerView.Adapter<ChatAdapter.ChatViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ChatViewHolder, position: Int) {
        ...
        Glide.with(context).load(user.imageUr).into(holder.binding.userImage)
